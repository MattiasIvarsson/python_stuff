 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "   Output || JSON: D_Datum.json         | Destination: C:\\Projekt\\PythonExport\\\\JSON\\D_Datum.json\n",
      "   Output || CSV:  D_Datum.csv          | Destination: C:\\Projekt\\PythonExport\\\\CSV\\D_Datum.csv\n",
      "________________________________________________\n",
      "\n",
      "2. Input  || QVD:  D_Tid.qvd            | Source:      C:\\Projekt\\Qlik\\QVD\\D_Tid.qvd\n",
      "   Output || JSON: D_Tid.json           | Destination: C:\\Projekt\\PythonExport\\\\JSON\\D_Tid.json\n",
      "   Output || CSV:  D_Tid.csv            | Destination: C:\\Projekt\\PythonExport\\\\CSV\\D_Tid.csv\n",
      "________________________________________________\n",
      "\n",
      "3. Input  || QVD:  F_BefolkningSCB.qvd  | Source:      C:\\Projekt\\Qlik\\QVD\\F_BefolkningSCB.qvd\n",
      "   Output || JSON: F_BefolkningSCB.json | Destination: C:\\Projekt\\PythonExport\\\\JSON\\F_BefolkningSCB.json\n",
      "   Output || CSV:  F_BefolkningSCB.csv  | Destination: C:\\Projekt\\PythonExport\\\\CSV\\F_BefolkningSCB.csv\n",
      "________________________________________________\n",
      "\n",
      " END - APP\n"
     ]
   ...
   "source": [
    ...
    "destination_path = 'C:\\Projekt\\PythonExport\\\\'\n",
    "\n",
